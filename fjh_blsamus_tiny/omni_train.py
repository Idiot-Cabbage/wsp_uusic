...
parser.add_argument('--cfg', type=str, default="/root/autodl-tmp/wsp_uusic/fjh_blsamus_tiny/configs/tiny_samus_config.yaml", # samus_config   swin_tiny_patch4_window7_224_lite
