...
from utils.omni_dataset import position_prompt_dict
from utils.omni_dataset import nature_prompt_dict

from utils.omni_dataset import position_prompt_one_hot_dict
from utils.omni_dataset import nature_prompt_one_hot_dict
from utils.omni_dataset import type_prompt_one_hot_dict
...
class TransformAdapter:
    ...
    def __call__(self, image, mask):
        ...
        # 返回与JointTransform2D兼容的三个值
        return result['image'], result['mask'], result['mask']
