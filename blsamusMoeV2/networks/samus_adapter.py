...
class SAMUSAdapter(nn.Module):
    ...
    def __init__(self, config, prompt=False):
        ...
        # 初始化 SAMUS 分割模型
        self.samus_model = moesamus_model_registry['vit_b'](
    ...
    def forward(self, x):
        ...
        try:
            ...
            router_logits = samus_output.get('router_logits', None)
            ...
            for i in range(batch_size):
                ...
                with torch.cuda.amp.autocast():
                    ...
                    router_logits = single_output.get('router_logits', None)
        ...
        return (seg_logits, x_cls_2_way, x_cls_4_way,router_logits)     
